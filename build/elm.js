...
var $elm$url$Url$Parser$State = F5(
	function (visited, unvisited, params, frag, value) {
		return {s: frag, t: params, q: unvisited, m: value, v: visited};
	});
...
var $author$project$Main$toLocation = function (string) {
	var _v0 = $elm$url$Url$fromString(string);
	if (_v0.$ === 1) {
		return {K: $author$project$Main$NotFound, G: ''};
	} else {
		var url = _v0.a;
		return {
			K: A2(
...
var $author$project$Main$init = function (flags) {
	return _Utils_Tuple2(
		{
			r: 0,
			F: $author$project$Main$toLocation(flags)
		},
...
var $author$project$Main$subscriptions = function (model) {
	return $author$project$Ports$onUrlChange(
		A2($elm$core$Basics$composeR, $author$project$Main$toLocation, $author$project$Main$UrlChanged));
};
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 1:
				...
				return _Utils_Tuple2(
					model,
					$author$project$Ports$pushUrl(path));
			case 2:
				return _Utils_Tuple2(
					_Utils_update(
						model,
...
var $author$project$Main$Increment = {$: 3};
...
var $author$project$Main$navigationLink = F2(
	function (path, label) {
		return A2(
			$elm$html$Html$a,
			_List_fromArray(
				[
					...
					$elm$json$Json$Decode$succeed(
						_Utils_Tuple2(
							$author$project$Main$NavigateTo(path),
							true)))
				]),
			_List_fromArray(
				[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								A2($author$project$Main$navigationLink, '/', 'Home')
							])),
						A2(
						$elm$html$Html$li,
						_List_Nil,
						_List_fromArray(
							[
								A2($author$project$Main$navigationLink, '/profile', 'Profile')
							])),
						A2(
						$elm$html$Html$li,
						_List_Nil,
						_List_fromArray(
							[
								A2($author$project$Main$navigationLink, '/reviews/the-century-of-the-self', 'The Century of the Self')
							])),
						A2(
						$elm$html$Html$li,
						_List_Nil,
						_List_fromArray(
							[
								A2($author$project$Main$navigationLink, '/reviews/public-opinion', 'Public Opinion')
							])),
						A2(
						$elm$html$Html$li,
						_List_Nil,
						_List_fromArray(
							[
								A2($author$project$Main$navigationLink, '/reviews/shah-of-shahs', 'Shah of Shahs')
							]))
					]))
			]));
};
